...
<div class="product-item1">
  ...
  <div class="product-list1">
    <h3>Крем для рук с шоколадом </h3>
      <span class="price1">199 ₽ </span>
...
<div class="product-item2">
  ...
  <div class="product-list2">
    <h3>Крем для рук с запахом мяты</h3>
      <span class="price2">199 ₽ </span>
...
<div class="product-item3">
  ...
  <div class="product-list3">
    <h3>Крем для рук с клубникой</h3>
...
<div class="product-item4">
  ...
  <div class="product-list4">
    <h3>Масло для тела питающее</h3>
      <span class="price4">630 ₽ </span>
...
<div class="product-item5">
  ...
  <div class="product-list5">
    <h3>Масло для тела увлажняющее</h3>
      <span class="price4">630 ₽ </span>
...
<div class="product-item6">
  ...
  <div class="product-list6">
    <h3>Маска для рук тканевая</h3>
      <span class="price6">100 ₽ </span>
...
<div class="product-item7">
  ...
  <div class="product-list7">
    <h3>Густое масло для рук</h3>
      <span class="price7">540 ₽ </span>
...
<div class="product-item10">
  ...
  <div class="product-list10">
    <h3>Масло-крем для тела</h3>
      <span class="price10">1250 ₽ </span>
...
<div class="product-item11">
  ...
  <div class="product-list11">
    <h3>Спрей для тела</h3>
      <span class="price11">289 ₽ </span>
